...
const onSubmit = (data)=>{
 ...
 <div className='flex justify-center items-center min-h-[60vh] '>
  <div className='border-2 border-black p-6 min-h-[40vh] rounded-2xl bg-neutral '>
    <h1 className='text-amber-50 text-2xl font-bold  text-center p-4 '>Sign Up</h1>
  ...
  <input type="password" className="input" placeholder="Password" {...register('Pass')} />
